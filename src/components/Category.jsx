  ...
  return (
    <>
      <div className="min-h-[50vh] flex justify-center items-center flex-col">
        <div className="flex w-full justify-center mt-[35px] space-x-2 h-[150px]">
          <input
            type="text"
            placeholder="Find Your Doctor ..."
            className="h-[55px] w-[550px] rounded-2xl border-solid border-3 drop-shadow-2xl shadow-xl border-zinc-500 outline-none pl-3"
          />
          <input
            type="text"
            placeholder="Location "
            className="h-[55px] min-w-[150px] rounded-2xl border-solid border-3 drop-shadow-2xl shadow-xl border-zinc-500 outline-none pl-3"
          />
        </div>
